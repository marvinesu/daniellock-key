export const site={name:"Daniel's Lock & Key",domain:'https://danielslockkey.com',preview:'https://daniels.webxni.com',phone:'(310) 600-2849',phoneHref:'+13106002849',market:'Hollywood',areas:['Hollywood','West Hollywood','East Hollywood','Los Feliz','Silver Lake','Central Los Angeles'],license:'California Locksmith Company LCO 8506',email:'',publishedAddress:'6220 Selma Ave, Apt 551, Los Angeles, CA 90028',addressNote:'Address published on the previous website. Mobile service—call before visiting.',socials:[{label:'Facebook',url:'https://www.facebook.com/DanielsLockandKeyService'},{label:'Instagram',url:'https://www.instagram.com/danielslock_keyservice/'},{label:'YouTube',url:'https://www.youtube.com/@DanielsLockKeys'}]} as const;
