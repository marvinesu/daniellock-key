export const site={name:"Daniel's Lock & Key Service",domain:'https://danielslockkey.com',preview:'https://daniels.webxni.com',phone:'(310) 600-2849',phoneHref:'+13106002849',market:'Hollywood',areas:['Hollywood','West Hollywood','Los Feliz','Silver Lake','Fairfax','Mid-City','Downtown Los Angeles','Beverly Grove','Echo Park'],license:'CA BSIS Locksmith Company License LCO8506',email:'',socials:[{label:'Facebook',url:'https://www.facebook.com/DanielsLockandKeyService'},{label:'Instagram',url:'https://www.instagram.com/danielslock_keyservice/'},{label:'YouTube',url:'https://www.youtube.com/@DanielsLockKeys'},{label:'Pinterest',url:'https://www.pinterest.com/danielslocknkeys/'},{label:'X',url:'https://x.com/danielslockkeys'}]} as const;
